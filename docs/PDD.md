...
_Focus: Establishing the user's baseline, connecting external data sources, and setting the "Battery" parameters._
...
**US-1.2: Wearable Data Connection**

- **As a** user with a wearable (Apple Health, etc.) or just a smartphone,
- **I want to** authorize Flux to read my Sleep and Step data (or input it manually),
...
## Epic 2: The "Readiness Engine" (Core Logic)

_Focus: The algorithm that decides "What workout do I do today?" based on inputs._
...
_Focus: The interface and mechanics of actually performing the workout._
...
- **As a** gym-goer,
- **I want** my phone to vibrate when a rest timer ends,
...
- **So that** the system learns if the weights are too heavy or too light for next time.

---

## Epic 4: The "Battery" Dashboard & Recovery

_Focus: Visualization of energy balance and gamifying recovery._
...
- **As a** user,
- **I want to** receive a notification summary of my energy balance,
...
_Focus: Backend stability, data security, and content management._
...
- **I want to** easily upload new exercises, videos, and tags (e.g., "Legs," "Low Impact") to the database,
- **So that** the users have a diverse database to pull workouts from.

**US-5.2: Data Privacy Compliance**

- **As a** user,
- **I want** my health data to be secure and private,
- **So that** I feel safe sharing sensitive biometric data.

**US-5.3: Offline Mode**

- **As a** user in a basement gym with no signal,
- **I want to** be able to start and complete a workout that was already cached,
